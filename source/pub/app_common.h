...
/* 通道输入事件定义，不要修改事件定义码。 */
#define INPUT_EVENT_NONE          0x55              /* 无事件发生                        */
...
#define INPUT_FUNC_NONE_CMD                 0       /* 输入通道无控制命令   */   
...
#define SWITCH_FUNC_NOACTION                0                       /* 开关功能无动作             */
