/*****************************************************************************************
* Copy right (C) for Nanjing shufan Information technology Co.,Ltd.(2016)
*
...
/************************************************************************************
* function name   : VOID Stm32G0xx_Iwdg_Init(WORD16 wWdgTime)
...
*************************************************************************************/
VOID Stm32G0xx_Iwdg_Init(WORD16 wWdgTime)
{
    BYTE ucIndex;
    WORD16 wValue = 0;
    ...
    /* we calculate the prescaler and the load value.the iwdg's clock is 32KHz. */
    for(ucIndex=0;ucIndex<7;ucIndex++)
    {
        wValue = (wWdgTime * 32)/sg_IwdgPrescaler[ucIndex];
...
/************************************************************************************
* function name   : VOID Stm32G0xx_Iwdg_Reset(VOID)
...
* 2016-08-03      V1.00                 Creation
*************************************************************************************/
VOID Stm32G0xx_Iwdg_Reset(VOID)
{
