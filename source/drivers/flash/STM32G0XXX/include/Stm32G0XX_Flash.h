/*******************************************************************
* (C) Copyright 2016 Nanjing shufan information Co,. Ltd.
*
...
#define FLASH_READ_PROTECT_LEVEL_0                        0x00aa
#define FLASH_READ_PROTECT_LEVEL_1                        0x00bb
#define FLASH_READ_PROTECT_LEVEL_2                        0x00cc

/****************************************************
*   Structure:   T_FTFA_MEM_MAP
*   Description: memory map of flash management register.
*   Parameter:
*   Authour: 
*   Modify record:
*   Date:  2016-8-2 creat.
...
#define FTFA_CMD_DELAY_STEP                      50
#define FTFA_CMD_ERASE_TIME                      800           /* flash erasing over time.    */
#define FTFA_CMD_WRITE_TIME                      10            /* flash programing over time. */
#define FTFA_APP_CHK_TIME                        1470          /* 63 bytes time. */
...
#define FLASH_OPTKEY1                        ((uint32_t)0x08192a3b)        /* Flash option key1 */
#define FLASH_OPTKEY2                        ((uint32_t)0x4c5d6e7f)        /* Flash option key2: used with FLASH_OPTKEY1 to
...
/* Flash control */
#define EN_READ_PROTECT                     1            /* Enable flash read protect   */
#define DIS_READ_PROTECT                    0            /* Disable flash read protect  */
#define FLASH_MASS_ERASE                    2            /* Falsh mass erase            */
