...
#define SW_COMM_NOT_READY        (0)         /* 发送未完成/接收无数据/设备未准备好 */
...
* 参数列表：
 ...
 -------------------------------------------------------------------------------------------------
  Output ucPara[3]      BYTE      命令为获取状态SW_COMM_GET_RX_STAT/SW_COMM_GET_TX_STAT是：
                                  ...
                                  SW_COMM_NOT_READY        发送未完成/接收无数据/设备未准备好
*******************************************************************************************************************/
...
/**************************************************************************
* 函数名称：WORD32 API_ComDrv_Read(BYTE ucDevID,T_DATA_OPERARTION *ptDataOp)
* 功能说明：通讯层接收数据接口。
