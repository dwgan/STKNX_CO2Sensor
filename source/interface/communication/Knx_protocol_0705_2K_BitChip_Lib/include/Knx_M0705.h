...
/**************************************************************************************************************
* 函数名称：BYTE KnxMask_GetMemTypeOfRange(WORDPTR dwStart,WORD16 wLength)
* 功能描述：rectrieves the memory type of a given address range in virtual memory space.
* 输入参数：WORD16 wAddr : the memory address.
* 输出参数：no.
* 返 回 值：MEM_TYPE_EEPROM : the address in flash area.
...
/**************************************************************************************************************
* 函数名称：BYTE KnxMask_GetMemTypeOfByte(WORDPTR dwAddr)
* 功能描述：rectrieves the memory type of a given address in virtual memory space.
* 输入参数：WORD16 wAddr : the memory address.
* 输出参数：no.
* 返 回 值：MEM_TYPE_EEPROM : the address in flash area.
            MEM_TYPE_RAM    : the address in RAM area.
