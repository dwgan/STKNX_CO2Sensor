...
/****************************************************************************************************************
* Function: VOID KnxLl_RxByte(BYTE ucDevNo,BYTE ucByte)
* Descrip.: Byte rxing handler.
* Input   : BYTE ucDevNo : which device.
*           BYTE ucByte  : received byte.
* Output  : none.
* Return  : none.
* Date             Version     Author        Content
* -------------------------------------------------------------------------------------------------------------
* 2019/04/01        V1.0      Danny.cao      creation
***************************************************************************************************************/
VOID KnxLl_RxByte(BYTE ucDevNo,BYTE ucByte);

/****************************************************************************************************************
* Function: VOID KnxLl_RxComplete(VOID)
* Descrip.: link layer receives a total frame.
* Input   : none.
* Output  : none.
* Return  : none.
* Date             Version     Author        Content
...
* 2019/04/01        V1.0      Danny.cao      creation
***************************************************************************************************************/
VOID KnxLl_RxComplete(VOID);

/****************************************************************************************************************
* Function: VOID KnxLl_Confirm(BYTE ucConfirm)
* Descrip.: link layer's confirm handler.
* Input   : none.
* Output  : none.
* Return  : none.
* Date             Version     Author        Content
...
* 2019/04/01        V1.0      Danny.cao      creation
***************************************************************************************************************/
VOID KnxLl_Confirm(BYTE ucConfirm);
