...
#define KNX_STANDARD_BUFFER_MAX_LEN  24     /* Max. standard buffer length exluding checksum. */
...
#define GET_SEQ_NUMBER(pucPayload)       (pucPayload[POS_TPDU_APCI] & KNX_TPDU_SEQ_MASK)
